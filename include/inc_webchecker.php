<?php
	...
	{
		mysqli_query('TRUNCATE webcheck');
	}
	...
	$result = mysqli_query($conn, 'SELECT webcheck.botid, botlist.country, botlist.country_code, webcheck.website, webcheck.status FROM webcheck, botlist WHERE webcheck.botid = botlist.botid;');
